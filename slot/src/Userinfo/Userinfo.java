...
public class Userinfo extends JPanel implements ActionListener {
	...
	private JPanel createInfoPanel() {
		...
		Object[][] personalInfoData = { { "아이디", user.getId() }, { "비밀번호", user.getPassword() },
				{ "이름", user.getName() }, { "생일", user.getBirthdate() } };
		...
		Object[][] statsData = { { "승률", "100%" }, { "금액", "1000" }, { "환전한 칩 개수", user.getChipNum() } };
