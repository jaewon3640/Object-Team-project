...
public class MainPage extends JFrame {
    ...
    public MainPage(User user) {
        ...
        JButton rankingButton = createRetroButton("View Ranking", 300, 360);
        JButton userInfoButton = createRetroButton("User Info", 300, 440);
        JButton exitButton = createRetroButton("Exit Game", 300, 520);

        startGameButton.addActionListener(e -> JOptionPane.showMessageDialog(this, "Starting the game..."));
        chipExchangeButton.addActionListener(e -> new ChipExchangePage(user).startGUI());
        rankingButton.addActionListener(e -> new Ranking().setVisible(true));
