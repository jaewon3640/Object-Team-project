...
public class HowToPlay extends JPanel {
    public HowToPlay(CardLayout cardLayout, JPanel mainPanel) {
      ...
      Timer  timer = new Timer(500, e -> {
        ...
        JLabel paylineExplanation = new JLabel("<html><b>&nbsp;&nbsp;&nbsp;<font color='red'>페이라인이란?:</font>슬롯의 정해진 시스템에 따라 당첨금을 지급하는 방식."
        ...
        paylineDetails.setText("- 게임 화면에서 1, 3, 5, 7, 9, 10개의 페이라인을 선택할 수 있습니다.\n"
                + "- 모든 페이라인은 기본 점수 100점을 가집니다.\n"
        		+ "- 페이라인 개수 선택 별로 아래와 같은 배수로 점수를 획득합니다\n"
                + "- 페이라인 1개 선택 시 : 10배\n"
                + "- 페이라인 3개 선택 시 : 5배\n"
                + "- 페이라인 5개 선택 시 : 3배\n"
                + "- 페이라인 7개 선택 시 : 2배\n"
                + "- 페이라인 9개 선택 시 : 1.5배\n"
                + "- 페이라인 10개 선택 시 : 1배\n\n"
                + "- 페이라인을 많이 선택할 수록 당첨될 확률이 올라가지만, 게임 당 소비되는 칩의 개수가 늘어나고,\n  당첨 시 획득 점수도 줄어듭니다.");
